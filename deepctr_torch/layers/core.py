...
class DNN(nn.Module):
    ...
    def __init__(self, inputs_dim, hidden_units, activation='relu', l2_reg=0, dropout_rate=0, use_bn=False,
                 output_activation=None, output_bias=True, init_std=0.0001, dice_dim=3, seed=1024, device='cpu'):
        ...
        if not output_bias:
            self.linears[-1] = nn.Linear(hidden_units[-2], hidden_units[-1], bias=False)
