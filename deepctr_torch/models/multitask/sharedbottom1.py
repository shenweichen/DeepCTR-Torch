...
class SharedBottom1(BaseModel):
    ...
    def __init__(self, dnn_feature_columns, bottom_dnn_hidden_units=(256, 128), tower_dnn_hidden_units=(64,),
        ...
        super(SharedBottom1, self).__init__(linear_feature_columns=[], dnn_feature_columns=dnn_feature_columns,
        ...
        self.tower_dnn = nn.ModuleList(
            [DNN(bottom_dnn_hidden_units[-1], list(tower_dnn_hidden_units) + [1], activation=dnn_activation,
                 l2_reg=l2_reg_dnn, dropout_rate=dnn_dropout, use_bn=dnn_use_bn,
    ...
    def forward(self, X):
        ...
        for i in range(self.num_tasks):
            tower_logit = self.tower_dnn[i](shared_bottom_output)
