...
from ..layers import CrossNetM, DNN


class DCNM(BaseModel):
    """Instantiates the DCN-M model.
    ...
    def __init__(self,linear_feature_columns,
        ...
        super(DCNM, self).__init__(linear_feature_columns=linear_feature_columns,
        ...
        self.add_regularization_loss(self.crossnet.weight, l2_reg_cross)
        self.to(device)
